...
LoadingState.preload = function () {
    ...
    const cdnUrl = "https://hytop-backend.onrender.com/static/hackyformer/assets/";
    this.game.load.json('level:0', 'level00.json');

    let playerSpriteUrl = playerSprite || `${cdnUrl}player.png`;
    let spiderSpriteUrl = spiderSprite || `${cdnUrl}spider.png`;
    let coinSpriteUrl = coinSprite || `${cdnUrl}coin_animated.png`;
    let keySpriteUrl = keySprite || `${cdnUrl}key.png`;
    ...
    this.game.load.image('key', keySpriteUrl);

    this.game.load.spritesheet('decoration', `${cdnUrl}decor.png`, 42, 42);
    this.game.load.spritesheet('hero', playerSpriteUrl, 32, 32);
    this.game.load.spritesheet('coin', coinSpriteUrl, 22, 22);
    this.game.load.spritesheet('spider', spiderSpriteUrl, 42, 32);
...
window.onload = function () {
    game = new Phaser.Game(350, 600, Phaser.AUTO, "", "", false, false);
